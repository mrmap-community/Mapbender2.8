...
abstract class Wfs extends Ows {
	...
	public static function findGeomColumnNameByFeaturetypeId($ftId) {
		$geomTypesArray = array('GeometryPropertyType','PointPropertyType','LineStringPropertyType','PolygonPropertyType','MultiPointPropertyType','MultiLineStringPropertyType','MultiPolygonPropertyType','SurfacePropertyType');
