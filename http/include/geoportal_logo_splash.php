<?php
$guiIdMessage = $this->guiId;

if ($this->guiId == 'Geoportal-Hessen-2019') {
    $guiIdMessage = 'Geoportal-Hessen';
}
echo	"<table style='padding-top:100px;margin-top:-15px' width='100%'><tr align='center'><td>" .
	...
	"<tr align='center'><td><p style='color:black;font-size:12.8px;font-family:Verdana,Sans Serif !important'>Lade Anwendung: " . $guiIdMessage . "</p></td></tr>".
	...
	"<a style='font-size:12.8px;text-decoration: underline;color:red;font-family:Verdana,Sans Serif !important;' href='https://".$_SERVER['HTTP_HOST']."/article/Browsereinstellung' target='_blank'>Link</a></p></td></tr>" .
