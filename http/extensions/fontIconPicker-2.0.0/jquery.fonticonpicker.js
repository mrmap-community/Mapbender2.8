...
;(function ($) {
	...
	Plugin.prototype = {
		...
		init: function () {
			 ...
			 * Category changer
			 */
			this.selectCategory.bind('change keyup', $.proxy(function(e) {
			 ...
			 * Quit search
			 */
			this.iconPicker.find('.selector-search').bind('click', '.fip-icon-cancel', $.proxy(function () {
			 ...
			 * On icon selected
			 */
			this.iconContainer.delegate('.fip-box', 'click', $.proxy(function (e) {
