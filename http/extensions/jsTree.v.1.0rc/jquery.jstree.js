...
(function ($) {
	$.jstree.plugin("checkbox", {
        ...
        defaults :{
            check_recursively: true // specifies wether checking a checkbox, also checks/unchecks all children, and sets parent tristate
        },
		_fn : {
			...
			change_state : function (obj, state) {
                ...
                if(s.checkbox.check_recursively){
                    ...
                    else { obj.andSelf().removeClass("jstree-unchecked jstree-undetermined").addClass("jstree-checked"); this.data.ui.last_selected = obj; }
                }
