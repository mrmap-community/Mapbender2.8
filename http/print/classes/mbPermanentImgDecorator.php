...
class mbPermanentImgDecorator extends mbTemplatePdfDecorator
{
    ...
    public function decorate()
    {
        ...
        if ($this->hasValue("mypermanentImage")) {
            $permanentImage = $this->getValue("mypermanentImage");
        } else {
        ...
        foreach ($markers as $marker) {
            ...
            $pdf_marker_off_x = ($marker->offset_x * 25.4) / $dpi; //unit: mm
            ...
            $pdf_img_dx = ($marker->width * 25.4) / $dpi; //unit: mm
