...
//$md_topic_categories = "{1}{3}{7}";

//$md_topic_categoriesArray = explode(",",trim(str_replace("}{",",",$md_topic_categories),"{}"));




//echo gettype($md_topic_categoriesArray);
//echo json_encode($md_topic_categoriesArray);
//die();
...
//get organisation info from webservice
