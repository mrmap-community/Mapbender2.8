...
INSERT INTO gui_element_vars(fkey_gui_id, fkey_e_id, var_name, var_value, context, var_type) VALUES ('admin_wfs_metadata','body','css_class_bg','../css/metadataeditor.css','to define the color of the body','file/css');
...
INSERT INTO gui_element_vars(fkey_gui_id, fkey_e_id, var_name, var_value, context, var_type) VALUES ('admin_wfs_metadata','body','jq_datatables_css','../extensions/dataTables-1.7.5/media/css/demo_table_jui.css','css-file for jQuery datatables','file/css');
...
INSERT INTO gui_element (fkey_gui_id, e_id, e_pos, e_public, e_comment, e_title, e_element,e_src, e_attributes, e_left, e_top, e_width, e_height, e_z_index, e_more_styles, e_content, e_closetag, e_js_file, e_mb_mod, e_target, e_requires,e_url) VALUES ('admin_wfs_metadata','mb_md_wfs_select',2,1,'Select a WFS','Select WFS','div','','',NULL ,NULL,NULL ,NULL,NULL ,'','<table style=''cursor:pointer'' class=''display''></table>','div','../plugins/mb_metadata_wfs_select.js','','','jq_datatables','');
